<template>
    <div>
        ...
        <div class="box2" style="position:absolute; width:100%;height:75%;overflow:scroll">
            ...
            <x-button v-if="old == false" type="primary" plain style="border-radius:20px;width:90%" @click.native="test">test</x-button>
    ...
    export default {
        ...
        data(){
            ...
            mounted(){
                ...
                this.$axios.get("/coupon/getByUserId?openid=ss")
                .then((ret)=>{
                    this.couponList = []
