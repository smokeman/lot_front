    ...
    <div class="box">
        <div class="item1">
            <group title="">
                ...
                昵称<input type="text" v-model="user.nick" />

                <div v-if="ACTOR.status === status.BEGIN">
                    <div>请等待管理员开启</div>
                </div>
                ...
                <!--<div v-if="CHAT.status === 1">-->
                    <div v-if="ACTOR.status === status.ING">
                        ...
                        <x-button type="primary" @click.native="partin" plain style="border-radius:99px;width: 94%">参加</x-button>
                    </div>
                    <div v-if="OWNER.status === status.JOINED" style="margin-left:60px;font-size: 25px">
                    ...
                    <!--<div v-if="ACTOR.status === status.JOINED">
                        <cell title="距离开奖时间">
                        <countdown slot="value" v-model="time2" :start="start" @on-finish="finish"></countdown>
                            秒
                        </cell>
                    </div>-->
                <!--</div>-->
                <!--<x-number :value="1" :min="1" :title="'请输入金额'"></x-number>-->
        ...
        <div class="item2">
            ...
            <div class="box2 body-wrapper">
                ...
                <p v-for="player in CHAT.playerArr">{{ player.nick }}加入了抽奖</p>
            </div>
            </scroller>
            </group>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // this.user = {
            //     // nick:'',
            //     header:'http://dsadasdasjdkjaskldjalsdadasdsdsadasdasdas',
            //     openid:'123456789012345678901234567890',
            //     mch_id:1
            // }
        },
        methods: {
